# click_api v2.5.3 | internal/give_custom/lc
# @input: {give_name: string (JSON text component), give_data: compound}
$item replace entity @s weapon.mainhand with carrot_on_a_stick[minecraft:custom_data={clickAPI:{type:"left_click"}},minecraft:piercing_weapon={},minecraft:item_name=$(give_name)]
