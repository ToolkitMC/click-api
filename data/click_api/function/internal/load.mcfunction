...
# Versiyon bilgisi
data modify storage click_api:internal version set value "2.5.2"
...
tellraw @a[tag=click_api.debug] [{"text":"[click_api] ","color":"green","bold":true},{"text":"v2.5.2 Loaded","color":"white"}]
